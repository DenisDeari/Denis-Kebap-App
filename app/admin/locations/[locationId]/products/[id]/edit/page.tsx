...
import { getProductById, updateProduct, getMenus, getIngredients, getAddOns } from "@/lib/storage";
  ...
  useEffect(() => {
    async function loadData() {
      ...
      if (currentProduct) {
        ...
        setFormData({
          menuName: currentProduct.categoryId,
          productName: currentProduct.name,
          productPrice: currentProduct.price,
          tax: currentProduct.tax || 10,
          showProductInApp: currentProduct.showInApp ?? true,
          applicablePreparationTime: currentProduct.applicablePreparationTime ?? true,
          selectedIngredients: currentProduct.ingredients || [],
          selectedAddOns: currentProduct.addOns || [],
        });
      }
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Edit Products Details</h1>
      </div>
